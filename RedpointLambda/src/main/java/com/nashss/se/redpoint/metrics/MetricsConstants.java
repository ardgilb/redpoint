package com.nashss.se.redpoint.metrics;
/**
...
public class MetricsConstants {
    ...
    public static final String UPDATEGROUP_INVALIDATTRIBUTEVALUE_COUNT =
        "UpdateGroup.InvalidAttributeValueException.Count";
    ...
    public static final String GETCLIMB_CLIMBNOTFOUND_COUNT = "GetClimb.ClimbNotFoundException.Count";
}
